namespace FP2_Sonic_Mod.Patchers
{
    internal class FPResultsMenuPatcher
    {
        ...
        {
            // Check if we're in Gravity Bubble and a Wisp hasn't been used as Sonic. If so, unlock the achievement.
            if (FPStage.currentStage.stageID == 23 && !FPPlayerPatcher.UsedWisp && FPSaveManager.character == Plugin.sonicCharacterID)
